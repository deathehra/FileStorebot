...
class Bot(Client):
    ...
    async def start(self):
        ...
        try:
            ...
            self.LOGGER(__name__).info("\nBot Stopped. Join https://t.me/+fKjD0V-ndtA5NjM1 for support")
            sys.exit()

        self.set_parse_mode(ParseMode.HTML)
        self.LOGGER(__name__).info(f"Bot Running..!\n\nCreated by \nhttps://t.me/Movies8777")
...
| (_| (_) | |) | _|| _|| |__ | | >  <| _ \ (_) || | \__ \
 \___\___/|___/|___|_| |____|___/_/\_\___/\___/ |_| |___/
        ...
        try: await self.send_message(OWNER_ID, text = f"<b><blockquote> Bᴏᴛ Rᴇsᴛᴀʀᴛᴇᴅ by @Movies8777</blockquote></b>")
        except: pass
    ...
    def run(self):
        ...
        self.LOGGER(__name__).info("Bot is now running. Thanks to @Movies8777")
        try:
            loop.run_forever()
